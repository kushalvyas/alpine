...
def test_forward_with_return_features(coords):
    num_decoders = 10
    num_shared_layers = 5
    model = Strainer(in_features=2, out_features=3, hidden_features=178, hidden_layers=6, num_decoders=num_decoders, num_shared_layers=num_shared_layers, outermost_linear=True)
