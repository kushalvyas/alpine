...
parser.add_argument('--batch_size', type=float, default=(1e6), help='Number of epochs to train')
...
wire_model.compile(learning_rate=1e-4, scheduler = partial(torch.optim.lr_scheduler.LambdaLR, lr_lambda=lambda epoch: 0.95 ** (min(epoch/NUM_EPOCHS, 1))))
print(wire_model)
