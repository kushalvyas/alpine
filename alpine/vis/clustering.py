...
class KMeans:
    ...
    def __init__(self, n_clusters, random_state=None):
        ...
        assert random_state is None or isinstance(random_state, int), "Random state must be an integer or None"
        self.n_clusters = n_clusters
        self.random_state = random_state
        self.model = skc.KMeans(n_clusters=self.n_clusters, random_state=self.random_state)
