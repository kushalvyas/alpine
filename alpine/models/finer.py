...
def get_linear_layer(in_features, out_features, omega=30.0, first_bias_scale=None, bias=True, is_first=False):
...
class Finer(AlpineBaseModule):
    def __init__(self, in_features, hidden_features,
                 ...
                 omegas = [30.0], first_bias_scale=None, bias=True):
        ...
        self.model.append(get_linear_layer(in_features, hidden_features, 
                                           is_first=True, omega=omegas[0], 
                                           first_bias_scale=first_bias_scale, bias=bias))
        ...
        # Final layer
        self.model.append(get_linear_layer(hidden_features, out_features, is_first=False, omega=self.omegas[-1], bias=False))
