...
class SSIM(torchmetrics.Metric):
    ...
    def __init__(self, signal_shape,  data_range=1.0, kernel_size=11, sigma=1.5, reduction="elementwise_mean"):
        super().__init__()
        self.signal_shape = signal_shape 
        self.ssim = torchmetrics.image.StructuralSimilarityIndexMeasure(data_range=data_range, kernel_size=kernel_size, sigma=sigma, reduction=reduction)        
